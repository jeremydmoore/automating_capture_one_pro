...
# ============ variables ============ #
tell_co = 'Tell application "Capture One 20"'
...
class Variant():
    ...
    def get_layer_names(self):
        ...
        for layer in layer_list:
            ...
            # get name of layer
            command = command_stub + [f'{tell_co} to tell its document "{self.document}" to tell its collection id "{self.collection_id}" to set layer_name to name of layer {layer} of variant id "{self.id}"', 'return layer_name']
