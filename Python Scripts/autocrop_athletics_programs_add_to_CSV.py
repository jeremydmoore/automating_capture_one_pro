...
if __name__ == '__main__':
    ...
    # commented out applescript.get_user_input_int as we can get the size of the
    # parent image automatically removing a speed bump and possible point of failure
